...
// As variáveis de campanha precisam ser carregadas
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!isMobileDevice) {
    ...
    desktopAlert?.classList.remove("d-none");
  } else {
    desktopAlert?.classList.add("d-none");
  }
...
function abrirCampanhaEmail() {
  ...
  function atualizarFiltroEmail() {
    ...
    if (avisoLotesEl) {
      avisoLotesEl.classList.remove("aviso-lotes-destaque");
      if (emails.length === 0) {
